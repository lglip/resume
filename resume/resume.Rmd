...
academia <- tribble(
  ...
  "Doctoral Researcher", "Aug. 2019 -- Present", "Ghent University", "Ghent, BE",
    list("Research on topics in labour economics (90%), contributing to solving societal questions surrounding  the (Belgian) labour market",
         "Teaching assignments (10%), including the guidance of last-year students regarding their master's thesis and guest lectures on economic research",
...
general <- tribble(
  ...
  "Linear models -- (Ordered) logit models -- Meta-analysis -- Meta-regression -- Reliability and validity analysis -- Structural equation modeling",
