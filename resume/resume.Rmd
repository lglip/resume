...
#https://github.com/Aariq/curriculum-vitae/blob/master/CV/CV.pdf
...
\footnotesize
I am a joint PhD researcher in labour economics and sociology of labour at Ghent University and Vrije Universiteit Brussel with an interdisciplinary background. My present work focuses on the determinants of and contextual factors contributing to (ethnic) hiring discrimination. I have previously worked for consulting firms on data governance, data analytics, and HR projects. Besides, I have obtained a master’s degree in industrial and organisational psychology and a business degree in general management.
\normalsize
...
academia <- tribble(
  ...
  "Doctoral Researcher", "Aug. 2019 -- Present", "Ghent University", "Ghent, BE",
    list("Research on topics in labour economics, contributing to solving societal questions surrounding  the (Belgian) labour market",
         "Teaching assignments, including the guidance of last-year students regarding their master's thesis and guest lectures on economic research",
...
## Discussion Papers
```{r disc pubs}
exception <- "Is labour market discrimination against ethnic minorities better explained by taste or statistics? A systematic review of the empirical evidence"

publications %>%
  filter(journal %in% c("IZA Discussion Paper")) %>%
  mutate(journal = "IZA Institute of Labour Economics",
         rows = case_when(title == exception ~ 3.55,
                          title != exception ~ 2.75)) %>%
  brief_entries(what = glue::glue("\\textbf{<journal>} \\newline <title> \\newline <author>",
                                  .open = "<", .close = ">"),
...
outreach_s <- tribble(
  ...
  "Trends", "Newspaper article", "2021", "Belgian population",
  ...
  "Het Laatste Nieuws", "Newspaper article", "2020", "Belgian population",
    "My job disappears, my pay gets smaller, my promotion gets snubbed: This is how the Flemish people think about the future of their work", 2.9
  )
...
general <- tribble(
  ...
  "Linear models -- Logit models -- Meta-analysis -- Reliability and validity analysis -- Structural equation modeling",
...
**Sucker for R**
\newline
I am a sucker for everything related to R (ggplot2, Shiny, Xaringan…), my go-to environment for statistical computing. The content of this very resume is written in R, using R Markdown, the {{vitae}} package, and LaTeX typesetting.

\footnotesize
**Passionate about electronic music**
\newline
I have been playing the piano since I was 9 years old, albeit less frequently in the past few years. Moreover, between the ages of 15 and 22, I was active as a (electronic) music artist, producer, and event manager.

**Fond of the sea**
\newline
As a teenager, I longed to spend my summer vacations at the seaside. From my 18th birthday onwards, after an intensive year of training, I was able to combine this fondness for the sea with a student job as a lifeguard at the Belgian coast.
