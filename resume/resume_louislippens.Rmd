...
academia <- tribble(
  ...
  "Doctoral Researcher", "Aug. 2019 -- Present", "Ghent University", "Ghent, BE",
    list("Research on topics in labour economics, contributing to solving societal questions surrounding the (Belgian) labour market",
         "Teaching assignments, such as guiding last-year students with their master's thesis, coaching bachelor students on migration research topics, and giving guest lectures on empirical/experimental economic research",
